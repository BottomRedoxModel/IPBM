...
contains
  ...
  subroutine day_circle(id,surface_index,day)
    ...
    character(len=64):: si,sirel,o2,o2rel,ch4,ch4rel,ch4flux,don,donflux
    ...
    do i = 1,number_of_circles
      ...
      call relaxation(ice_water_index,water_bbl_index,day,&
                      ...
                      si,sirel,o2,o2rel,ch4,ch4rel,ch4flux,don,donflux,rp)
  ...
  subroutine relaxation(ice_water_index,water_bbl_index,day,&
    ...
    character(len=*),intent(in):: si,sirel,o2,o2rel,ch4,ch4rel,ch4flux,don,donflux
